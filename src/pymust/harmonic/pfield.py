...
def pfield(xbound, zbound, delaysTX : np.ndarray, param: utils.Param, options : utils.Options = None, lowResources = False):
    """
    ...
    if Nx > 250 and lowResources:
        print("Warning: Number of grid points in x is too large. Reducing to 250.")
        Nx = 250
    if Nz > 250 and lowResources:
        print("Warning: Number of grid points in z is too large. Reducing to 250.")
        Nz = 250
